...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-05-2026 a las 15:45:05
...
CREATE TABLE `materias` (
  ...
  `CURSOS_MATERIAS` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
INSERT INTO `materias` (`Id_materias`, `Nombre_materias`, `CURSOS_MATERIAS`) VALUES
...
--
ALTER TABLE `aulas`
  MODIFY `Id_aulas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
